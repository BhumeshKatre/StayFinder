...
import { FaGoogle, FaApple, FaFacebookF, FaEnvelope, FaTimes } from "react-icons/fa";
              ...
              
                {
                  providers.map((provider, idx) => (
                    <button
                      ...
                      onClick={() =>
                        alert(`${provider.name} Sign In functionality not implemented yet.`)
                      }
                    >
                      <span className="flex items-center gap-2">{provider.icon}</span>
                    </button>
                ))}
